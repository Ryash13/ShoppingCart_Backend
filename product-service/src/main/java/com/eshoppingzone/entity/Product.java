...
public class Product {
    ...
    @NotNull(message = "Enter the productType")
    private String productType;

    @NotNull(message = "Enter a valid Product Name")
    @Size(min = 3 ,max = 20, message = "Product Name must be in the range of 3 - 20 Characters")
    private String productName;

    @NotNull(message = "Mandatory to Enter the product Category")
